...
use {trezoa_keypair::Keypair, std::time::Duration};
...
/// set to this ratio times [`trezoa_packet::PACKET_DATA_SIZE`]
///
/// [`trezoa_packet::PACKET_DATA_SIZE`]: https://docs.rs/trezoa-packet/latest/trezoa_packet/constant.PACKET_DATA_SIZE.html
